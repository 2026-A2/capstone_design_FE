...
const voiceGuides = [
  {
    ...
    ranges: [
      { label: '매우 느림 <150', tone: 'red' },
      { label: '느림 150-199', tone: 'yellow' },
      { label: '적정 200-250', tone: 'green' },
      { label: '빠름 251-300', tone: 'yellow' },
      { label: '매우 빠름 >300', tone: 'red' },
    ],
...
const behaviorGuides = [
  {
    ...
    levels: [
      ...
      { label: '체크 필요', value: '65% 미만', tone: 'red' },
    ],
  ...
  },
  {
    ...
    levels: [
      { label: '적정', value: '20-40회/분', tone: 'green' },
      { label: '주의', value: '41-55회/분', tone: 'yellow' },
      { label: '체크 필요', value: '20회 미만 또는 55회 초과', tone: 'red' },
    ],
  ...
  },
  {
    ...
    levels: [
      { label: '안정', value: '분당 1회 이하', tone: 'green' },
      { label: '보통', value: '분당 2-3회', tone: 'yellow' },
      { label: '체크 필요', value: '분당 4회 이상', tone: 'red' },
    ],
  ...
  },
  {
    ...
    levels: [
      ...
      { label: '체크 필요', value: '75% 미만', tone: 'red' },
    ],
  ...
  },
  {
    ...
    levels: [
      ...
      { label: '체크 필요', value: '분당 6회 이상', tone: 'red' },
    ],
  ...
  },
  {
    ...
    levels: [
      { label: '적정', value: '11% 이상', tone: 'green' },
      { label: '주의', value: '5-10%', tone: 'yellow' },
      { label: '체크 필요', value: '5% 미만', tone: 'red' },
    ],
